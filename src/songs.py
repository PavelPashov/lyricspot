...
class Songs(Song):
    ...
    def recently_played_toJSON(self):
        """Parse the song to JSON."""
        return json.dumps(
            self.songs, default=lambda o: o.__dict__, sort_keys=True, indent=4
        )
...
class TopSongs(Songs):
    def fetch_top(self, _type="tracks", limit=50, term="short_term"):
        try:
            url = (
    ...
    def get_songs(self, limit=50, term="long_term"):
        self.fetch_top(limit=50, term=term)
